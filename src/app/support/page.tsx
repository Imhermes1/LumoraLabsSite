    ...
    <div className="relative isolate min-h-screen overflow-hidden pb-24 pt-24">
      ...
      >
        ...
        <div className="mt-10 glass-strong rounded-3xl p-8 md:p-12">
            ...
            <section className="mb-12">
              ...
              <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
                <div className="glass rounded-2xl p-6 text-center">
                  ...
                  <h3 className="text-gray-900 font-semibold mb-2">Search Help Center</h3>
                ...
                <div className="glass rounded-2xl p-6 text-center">
                  ...
                  <h3 className="text-gray-900 font-semibold mb-2">Live Chat Support</h3>
                  <p className="text-gray-600 text-sm mb-4">
              ...
              <div className="grid md:grid-cols-2 gap-6">
                <div className="glass rounded-2xl p-6">
                  <div className="flex items-center mb-4">
                    ...
                    <h3 className="text-gray-900 font-semibold text-lg">Getting Started</h3>
                  </div>
                  <p className="text-gray-600 mb-4">New to Macro or MooDo? We'll help you get up and running quickly.</p>
                ...
                <div className="glass rounded-2xl p-6">
                  <div className="flex items-center mb-4">
                    ...
                    <h3 className="text-gray-900 font-semibold text-lg">Technical Support</h3>
                  </div>
                  <p className="text-gray-600 mb-4">Experiencing technical issues? Our technical team can help resolve problems.</p>
                  <ul className="text-gray-600 text-sm space-y-2">
                ...
                <div className="glass rounded-2xl p-6">
                  <div className="flex items-center mb-4">
                    ...
                    <h3 className="text-gray-900 font-semibold text-lg">Billing & Account</h3>
                  </div>
                  <p className="text-gray-600 mb-4">Questions about your account or subscription? We handle all billing inquiries.</p>
                  <ul className="text-gray-600 text-sm space-y-2">
                ...
                <div className="glass rounded-2xl p-6">
                  <div className="flex items-center mb-4">
                    ...
                    <h3 className="text-gray-900 font-semibold text-lg">Privacy & Security</h3>
                  </div>
                  <p className="text-gray-600 mb-4">Concerned about your data privacy or security? We take these matters seriously.</p>
                  <ul className="text-gray-600 text-sm space-y-2">
            ...
            {/* Premium Support */}
            <section className="mb-12">
              <h2 className="text-2xl font-bold text-gray-900 mb-6">Premium Support</h2>
              ...
              <div className="grid md:grid-cols-2 gap-6">
                <div className="glass rounded-2xl p-6">
                  <div className="flex items-center mb-4">
                    ...
                    <h3 className="text-gray-900 font-semibold text-lg">Priority Support</h3>
                  </div>
                  <p className="text-gray-600 mb-4">Available for paid subscribers of Macro and MooDo applications.</p>
                  <ul className="text-gray-600 text-sm space-y-2">
                ...
                <div className="glass rounded-2xl p-6">
                  <div className="flex items-center mb-4">
                    ...
                    <h3 className="text-gray-900 font-semibold text-lg">Enterprise Support</h3>
                  </div>
                  <p className="text-gray-600 mb-4">For business and enterprise customers with special requirements.</p>
                  <ul className="text-gray-600 text-sm space-y-2">
            ...
            <section className="mb-12">
              ...
              <div className="grid md:grid-cols-2 gap-6">
                <div className="glass rounded-2xl p-6">
                  <h3 className="text-gray-900 font-semibold text-lg mb-4">Business Details</h3>
                ...
                <div className="glass rounded-2xl p-6">
                  <h3 className="text-gray-900 font-semibold text-lg mb-4">Support Channels</h3>
                  <div className="space-y-3">
                    <div>
                      <p className="text-gray-900 font-medium">General Support:</p>
                      <p className="text-lumora-pink">lumos@lumoralabs.io</p>
                    </div>
                    <div>
                      <p className="text-gray-900 font-medium">Business Hours:</p>
                      <p className="text-gray-600">Monday to Friday: 9:00 AM - 5:00 PM AEST</p>
                    </div>
                    <div>
                      <p className="text-gray-900 font-medium">Emergency Support:</p>
            ...
            <section className="mb-12">
              <h2 className="text-2xl font-bold text-gray-900 mb-6">Response Time Commitments</h2>
              
              <div className="grid md:grid-cols-3 gap-6">
                <div className="glass rounded-2xl p-6 text-center">
                  <h3 className="text-gray-900 font-semibold mb-3">Standard Support</h3>
                  <ul className="text-gray-600 text-sm space-y-2">
                ...
                <div className="glass rounded-2xl p-6 text-center">
                  <h3 className="text-gray-900 font-semibold mb-3">Priority Support</h3>
                  <ul className="text-gray-600 text-sm space-y-2">
                ...
                <div className="glass rounded-2xl p-6 text-center">
                  <h3 className="text-gray-900 font-semibold mb-3">Emergency Support</h3>
                  <ul className="text-gray-600 text-sm space-y-2">
            ...
            <section className="mb-12">
              <h2 className="text-2xl font-bold text-gray-900 mb-6">Australian Consumer Law and Your Rights</h2>
              ...
              <div className="glass rounded-2xl p-6">
                ...
                <h3 className="text-gray-900 font-semibold text-lg mb-3">Consumer Guarantees</h3>
                <p className="text-gray-600 mb-4">Our services come with guarantees that:</p>
                ...
                <h3 className="text-gray-900 font-semibold text-lg mb-3">Making a Complaint</h3>
                <p className="text-gray-600 mb-4">If you're not satisfied with our response:</p>
              ...
              <div className="glass rounded-2xl p-8">
                ...
                <div className="flex flex-col sm:flex-row gap-4 justify-center">
                  <a 
                    ...
                    className="bg-gradient-to-r from-lumora-pink to-lumora-purple rounded-full px-8 py-3 text-gray-900 font-semibold hover:shadow-lg hover:shadow-lumora-purple/25 transition-all duration-300 inline-flex items-center justify-center"
                  >
                    <Mail size={20} className="mr-2" />
                    Email Support
                  </a>
                  <button className="border border-gray-200/60 rounded-full px-8 py-3 text-gray-900 font-semibold transition-all duration-300 hover:border-lumora-purple/50 hover:bg-lumora-purple/10">
                    Start Live Chat
                  </button>
                </div>
              </div>
