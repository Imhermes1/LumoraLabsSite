      ...
      <div className="relative">
        ...
        <section className="py-16">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="rounded-3xl border border-black/12 bg-[rgba(24,28,36,0.1)] p-8 md:p-12 backdrop-blur-xl shadow-[0_26px_64px_-35px_rgba(15,23,42,0.6)]">
        ...
        <section className="py-16">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid md:grid-cols-3 gap-8">
              <div className="rounded-3xl border border-black/15 bg-[rgba(24,28,36,0.12)] p-8 text-center backdrop-blur-xl shadow-[0_24px_60px_-35px_rgba(15,23,42,0.55)]">
        ...
        <section className="py-16">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="rounded-3xl border border-black/12 bg-[rgba(24,28,36,0.1)] p-8 md:p-12 text-center backdrop-blur-xl shadow-[0_26px_64px_-35px_rgba(15,23,42,0.6)]">
              <h2 className="text-3xl md:text-4xl font-bold text-white mb-6">
                Join the Revolution
              </h2>
