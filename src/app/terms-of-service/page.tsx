          ...
          <div className="prose prose-lg max-w-none">
              ...
              <section className="mb-8">
                ...
                <div className="glass rounded-xl p-4 mb-4">
                  <h3 className="text-gray-900 font-semibold mb-2">Company Details:</h3>
              ...
              <section className="mb-8">
                ...
                <h3 className="text-xl font-semibold text-gray-900 mb-3">2.1 Service Overview</h3>
                <p className="text-gray-600 mb-4">Lumora Labs provides:</p>
                ...
                <h3 className="text-xl font-semibold text-gray-900 mb-3">2.2 Service Modifications</h3>
              ...
              <section className="mb-8">
                ...
                <p className="text-gray-600 mb-4">We may suspend or terminate your account if you:</p>
                <ul className="text-gray-600 space-y-2 mb-4">
              ...
              <section className="mb-8">
                ...
                <p className="text-gray-600 mb-4">You may use our Services to:</p>
                <ul className="text-gray-600 space-y-2 mb-4">
              ...
              <section className="mb-8">
                ...
                <h3 className="text-xl font-semibold text-gray-900 mb-3">5.2 Data Storage and Processing</h3>
                <p className="text-gray-600 mb-4">We use the following third-party services for data storage and processing:</p>
                <ul className="text-gray-600 space-y-2 mb-4">
                ...
                <h3 className="text-xl font-semibold text-gray-900 mb-3">5.3 Your Data Rights</h3>
                <p className="text-gray-600 mb-4">You retain ownership of your personal data and content. We process your data in accordance with:</p>
                <ul className="text-gray-600 space-y-2 mb-4">
              ...
              <section className="mb-8">
                <h2 className="text-2xl font-bold text-gray-900 mb-4">6. Consumer Guarantees and Australian Consumer Law</h2>
                
                <h3 className="text-xl font-semibold text-gray-900 mb-3">6.1 Consumer Guarantees</h3>
                <p className="text-gray-600 mb-4">Under the Australian Consumer Law (ACL), our Services come with guarantees that cannot be excluded. These include:</p>
                <ul className="text-gray-600 space-y-2 mb-4">
                ...
                <h3 className="text-xl font-semibold text-gray-900 mb-3">6.2 Limitation of Liability</h3>
                ...
                <h3 className="text-xl font-semibold text-gray-900 mb-3">6.3 Warranty Disclaimer</h3>
                <p className="text-gray-600 mb-4">Except for consumer guarantees that cannot be excluded:</p>
                <ul className="text-gray-600 space-y-2 mb-4">
              ...
              <section className="mb-8">
                ...
                <p className="text-gray-600 mb-4">Some Services may require payment of subscription fees:</p>
                <ul className="text-gray-600 space-y-2 mb-4">
                ...
                <h3 className="text-xl font-semibold text-gray-900 mb-3">7.3 Automatic Renewal</h3>
                <ul className="text-gray-600 space-y-2 mb-4">
              ...
              <section className="mb-8">
                ...
                <p className="text-gray-600 mb-4">We own all intellectual property rights in:</p>
                <ul className="text-gray-600 space-y-2 mb-4">
                ...
                <p className="text-gray-600 mb-4">You retain ownership of content you create using our Services, subject to:</p>
                <ul className="text-gray-600 space-y-2 mb-4">
                ...
                <h3 className="text-xl font-semibold text-gray-900 mb-3">8.3 License Grant</h3>
                <p className="text-gray-600 mb-4">
              ...
              <section className="mb-8">
                <h2 className="text-2xl font-bold text-gray-900 mb-4">9. Beta Testing and Pre-Release Features</h2>
                <p className="text-gray-600 mb-4">Some features may be offered in beta or pre-release form:</p>
                <ul className="text-gray-600 space-y-2 mb-4">
              ...
              <section className="mb-8">
                ...
                <h3 className="text-xl font-semibold text-gray-900 mb-3">10.1 Integration with Third Parties</h3>
                <p className="text-gray-600 mb-4">Our Services may integrate with third-party services including:</p>
                <ul className="text-gray-600 space-y-2 mb-4">
              ...
              <section className="mb-8">
                ...
                <h3 className="text-xl font-semibold text-gray-900 mb-3">11.1 Suspension</h3>
                <p className="text-gray-600 mb-4">We may suspend your access if:</p>
                <ul className="text-gray-600 space-y-2 mb-4">
                ...
                <h3 className="text-xl font-semibold text-gray-900 mb-3">11.2 Termination by You</h3>
                ...
                <h3 className="text-xl font-semibold text-gray-900 mb-3">11.3 Termination by Us</h3>
                <p className="text-gray-600 mb-4">We may terminate your account for:</p>
                <ul className="text-gray-600 space-y-2 mb-4">
                ...
                <h3 className="text-xl font-semibold text-gray-900 mb-3">11.4 Effect of Termination</h3>
              ...
              <section className="mb-8">
                ...
                <p className="text-gray-600 mb-4">Before initiating formal proceedings, you agree to:</p>
                <ul className="text-gray-600 space-y-2 mb-4">
                ...
                <h3 className="text-xl font-semibold text-gray-900 mb-3">12.2 Formal Disputes</h3>
                <p className="text-gray-600 mb-4">If informal resolution fails:</p>
                <ul className="text-gray-600 space-y-2 mb-4">
              ...
              <section className="mb-8">
                ...
                <p className="text-gray-600 mb-4">You agree to indemnify and hold harmless Lumora Labs from claims arising from:</p>
                <ul className="text-gray-600 space-y-2 mb-4">
              ...
              <section className="mb-8">
                ...
                <h3 className="text-xl font-semibold text-gray-900 mb-3">14.3 Assignment</h3>
                <p className="text-gray-600 mb-4">
                  You may not assign these Terms without our written consent. We may assign these Terms to any successor or affiliate.
                </p>

                <h3 className="text-xl font-semibold text-gray-900 mb-3">14.4 Governing Law</h3>
                <p className="text-gray-600 mb-4">
                ...
                <p className="text-gray-600 mb-4">We may update these Terms by:</p>
                <ul className="text-gray-600 space-y-2 mb-4">
              ...
              <section className="mb-8">
                ...
                <p className="text-gray-600 mb-4">For questions about these Terms or our Services:</p>
                <div className="glass rounded-xl p-4 mb-4">
                  <ul className="text-gray-600 space-y-1">
                    <li><strong>Email:</strong> lumos@lumoralabs.io</li>
                    <li><strong>Website:</strong> www.lumoralabs.io</li>
