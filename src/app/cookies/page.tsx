...
const CookiePolicy = () => {
  return (
    <div className="relative isolate min-h-screen overflow-hidden pb-24 pt-24">
      ...
      <div className="pointer-events-none absolute inset-y-0 right-[-12rem] top-32 -z-10 hidden lg:block">
        <div className="h-[26rem] w-[26rem] rounded-full bg-gradient-to-br from-lumora-purple/12 via-white/0 to-transparent blur-3xl" />
      </div>
      <div className="pointer-events-none absolute inset-y-0 left-[-14rem] bottom-0 -z-10 hidden xl:block">
        <div className="h-[22rem] w-[22rem] rounded-full bg-gradient-to-tl from-lumora-pink/12 via-white/0 to-transparent blur-3xl" />
      </div>
      ...
      >
        ...
        <div className="prose prose-lg max-w-none">
              ...
              <div className="text-gray-600 mb-8 p-4 glass rounded-xl">
                <p className="font-semibold text-gray-900 mb-2">Effective Date: 1 August 2025</p>
              ...
              <section className="mb-8">
                ...
                <h3 className="text-xl font-semibold text-gray-900 mb-3">2.1 Definition</h3>
                <p className="text-gray-600 mb-4">
                ...
                <h3 className="text-xl font-semibold text-gray-900 mb-3">2.2 Types of Cookies</h3>
                <div className="grid md:grid-cols-2 gap-4 mb-4">
                  <div className="glass rounded-xl p-4">
                    <h4 className="text-gray-900 font-semibold mb-2">Session Cookies</h4>
                    <p className="text-gray-600 text-sm">Temporary cookies that are deleted when you close your browser or app.</p>
                  </div>
                  <div className="glass rounded-xl p-4">
                    <h4 className="text-gray-900 font-semibold mb-2">Persistent Cookies</h4>
                    <p className="text-gray-600 text-sm">Remain on your device for a predetermined period or until you delete them.</p>
                  </div>
                  <div className="glass rounded-xl p-4">
                    <h4 className="text-gray-900 font-semibold mb-2">First-Party Cookies</h4>
                    <p className="text-gray-600 text-sm">Set directly by our website or applications.</p>
                  </div>
                  <div className="glass rounded-xl p-4">
                    <h4 className="text-gray-900 font-semibold mb-2">Third-Party Cookies</h4>
                    <p className="text-gray-600 text-sm">Set by external services we use (such as analytics providers).</p>
                  </div>
                </div>

                <h3 className="text-xl font-semibold text-gray-900 mb-3">2.3 Similar Technologies</h3>
                <p className="text-gray-600 mb-4">We also use similar technologies including:</p>
                ...
                <div className="grid md:grid-cols-2 gap-6 mb-6">
                  <div className="glass rounded-2xl p-6">
                    <div className="flex items-center mb-4">
                      ...
                      <h3 className="text-gray-900 font-semibold text-lg">Essential Cookies</h3>
                    </div>
                    <p className="text-gray-600 text-sm mb-3">These cookies are necessary for our Services to function properly and cannot be switched off.</p>
                  ...
                  <div className="glass rounded-2xl p-6">
                    <div className="flex items-center mb-4">
                      ...
                      <h3 className="text-gray-900 font-semibold text-lg">Performance & Analytics</h3>
                    </div>
                    <p className="text-gray-600 text-sm mb-3">These cookies help us understand how users interact with our Services.</p>
                    <ul className="text-gray-600 text-sm space-y-1">
                  ...
                  <div className="glass rounded-2xl p-6">
                    <div className="flex items-center mb-4">
                      ...
                      <h3 className="text-gray-900 font-semibold text-lg">Functionality Cookies</h3>
                    </div>
                    <p className="text-gray-600 text-sm mb-3">These cookies enhance your experience by remembering your preferences.</p>
                    <ul className="text-gray-600 text-sm space-y-1">
                  ...
                  <div className="glass rounded-2xl p-6">
                    <div className="flex items-center mb-4">
                      ...
                      <h3 className="text-gray-900 font-semibold text-lg">Marketing & Advertising</h3>
                    </div>
                    <p className="text-gray-600 text-sm mb-3">We currently do not use marketing or advertising cookies.</p>
                    <p className="text-gray-600 text-sm">If we implement advertising features, we will update this policy with clear information and seek appropriate consent.</p>
                  </div>
                </div>
              </section>

              <section className="mb-8">
                <h2 className="text-2xl font-bold text-gray-900 mb-4">4. Third-Party Services and Cookies</h2>
                
                <div className="space-y-4 mb-4">
                  <div className="glass rounded-xl p-4">
                    <h4 className="text-gray-900 font-semibold mb-2">Firebase (Google Cloud Platform)</h4>
                    <ul className="text-gray-600 text-sm space-y-1">
                  ...
                  <div className="glass rounded-xl p-4">
                    <h4 className="text-gray-900 font-semibold mb-2">Apple Services (iOS)</h4>
                    <ul className="text-gray-600 text-sm space-y-1">
                  ...
                  <div className="glass rounded-xl p-4">
                    <h4 className="text-gray-900 font-semibold mb-2">Notion (Internal Operations)</h4>
                    <ul className="text-gray-600 text-sm space-y-1">
              ...
              <section className="mb-8">
                <h2 className="text-2xl font-bold text-gray-900 mb-4">5. Your Cookie Choices and Control</h2>
                
                <h3 className="text-xl font-semibold text-gray-900 mb-3">5.1 Browser-Based Controls</h3>
                <p className="text-gray-600 mb-4">You can manage cookies through your browser settings:</p>
                
                <div className="grid md:grid-cols-2 gap-4 mb-4">
                  <div className="glass rounded-xl p-4">
                    <h4 className="text-gray-900 font-semibold mb-2">Google Chrome</h4>
                  ...
                  <div className="glass rounded-xl p-4">
                    <h4 className="text-gray-900 font-semibold mb-2">Safari</h4>
                    <ol className="text-gray-600 text-sm space-y-1">
                  ...
                  <div className="glass rounded-xl p-4">
                    <h4 className="text-gray-900 font-semibold mb-2">Firefox</h4>
                    <ol className="text-gray-600 text-sm space-y-1">
                  ...
                  <div className="glass rounded-xl p-4">
                    <h4 className="text-gray-900 font-semibold mb-2">Microsoft Edge</h4>
                    <ol className="text-gray-600 text-sm space-y-1">
                ...
                <h3 className="text-xl font-semibold text-gray-900 mb-3">5.2 Mobile App Controls</h3>
                <div className="grid md:grid-cols-2 gap-4 mb-4">
                  <div className="glass rounded-xl p-4">
                    <h4 className="text-gray-900 font-semibold mb-2">iOS (iPhone/iPad)</h4>
                    <ul className="text-gray-600 text-sm space-y-1">
                  ...
                  <div className="glass rounded-xl p-4">
                    <h4 className="text-gray-900 font-semibold mb-2">Android</h4>
                    <ul className="text-gray-600 text-sm space-y-1">
              ...
              <section className="mb-8">
                ...
                <div className="grid md:grid-cols-3 gap-4 mb-4">
                  <div className="glass rounded-xl p-4">
                    ...
                    <p className="text-gray-600 text-sm">Disabling essential cookies may result in:</p>
                  ...
                  <div className="glass rounded-xl p-4">
                    <h4 className="text-gray-900 font-semibold mb-2">Performance Cookies</h4>
                    <p className="text-gray-600 text-sm">Disabling performance cookies may result in:</p>
                    <ul className="text-gray-600 text-sm space-y-1 mt-2">
                  ...
                  <div className="glass rounded-xl p-4">
                    <h4 className="text-gray-900 font-semibold mb-2">Functionality Cookies</h4>
                    <p className="text-gray-600 text-sm">Disabling functionality cookies may result in:</p>
                    <ul className="text-gray-600 text-sm space-y-1 mt-2">
              ...
              <section className="mb-8">
                ...
                <h3 className="text-xl font-semibold text-gray-900 mb-3">7.1 Australian Privacy Compliance</h3>
                <p className="text-gray-600 mb-4">Our use of cookies complies with:</p>
                <ul className="text-gray-600 space-y-2 mb-4">
                ...
                <h3 className="text-xl font-semibold text-gray-900 mb-3">7.2 Data Security</h3>
                <p className="text-gray-600 mb-4">Cookie data is protected through:</p>
                <ul className="text-gray-600 space-y-2 mb-4">
                ...
                <h3 className="text-xl font-semibold text-gray-900 mb-3">7.3 Data Retention</h3>
                <p className="text-gray-600 mb-4">We retain cookie data for:</p>
                <ul className="text-gray-600 space-y-2 mb-4">
              ...
              <section className="mb-8">
                ...
                <h3 className="text-xl font-semibold text-gray-900 mb-3">8.1 Age Restrictions</h3>
                <p className="text-gray-600 mb-4">
                ...
                <h3 className="text-xl font-semibold text-gray-900 mb-3">8.2 Parental Controls</h3>
                <p className="text-gray-600 mb-4">Parents and guardians can:</p>
                <ul className="text-gray-600 space-y-2 mb-4">
              ...
              <section className="mb-8">
                ...
                <h3 className="text-xl font-semibold text-gray-900 mb-3">9.1 Policy Changes</h3>
                <p className="text-gray-600 mb-4">We may update this Cookies Policy to reflect:</p>
                <ul className="text-gray-600 space-y-2 mb-4">
                ...
                <h3 className="text-xl font-semibold text-gray-900 mb-3">9.2 Notification of Changes</h3>
                <p className="text-gray-600 mb-4">We will notify you of significant changes through:</p>
                <ul className="text-gray-600 space-y-2 mb-4">
                ...
                <h3 className="text-xl font-semibold text-gray-900 mb-3">9.3 Continued Use</h3>
                <p className="text-gray-600 mb-4">
              ...
              <section className="mb-8">
                <h2 className="text-2xl font-bold text-gray-900 mb-4">10. Contact Us About Cookies</h2>
                
                <h3 className="text-xl font-semibold text-gray-900 mb-3">10.1 Questions and Requests</h3>
                <p className="text-gray-600 mb-4">For questions about this Cookies Policy or to exercise your rights:</p>
                <div className="glass rounded-xl p-4 mb-4">
                  <ul className="text-gray-600 space-y-1">
                    <li><strong>Email:</strong> lumos@lumoralabs.io</li>
                ...
                <h3 className="text-xl font-semibold text-gray-900 mb-3">10.2 Complaints Process</h3>
                <p className="text-gray-600 mb-4">If you have concerns about our cookie practices:</p>
                ...
                <h3 className="text-xl font-semibold text-gray-900 mb-3">10.3 Cookie-Related Requests</h3>
              ...
              <section className="mb-8">
                <h2 className="text-2xl font-bold text-gray-900 mb-4">11. Additional Resources</h2>
                
                <h3 className="text-xl font-semibold text-gray-900 mb-3">11.1 Third-Party Cookie Policies</h3>
                <ul className="text-gray-600 space-y-2 mb-4">
                ...
                <h3 className="text-xl font-semibold text-gray-900 mb-3">11.2 Browser Help Resources</h3>
                <ul className="text-gray-600 space-y-2 mb-4">
                ...
                <h3 className="text-xl font-semibold text-gray-900 mb-3">11.3 Privacy Education</h3>
                <ul className="text-gray-600 space-y-2 mb-4">
