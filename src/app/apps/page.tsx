...
const imagePlaceholder = (
  <div className="flex h-64 items-center justify-center rounded-3xl border border-dashed border-white/20 bg-white/5 text-white/50">
      ...
      <header className="mx-auto mb-20 max-w-6xl px-6 sm:px-8">
        ...
        <div className="text-center">
          ...
          <p className="mx-auto mt-6 max-w-3xl text-lg leading-relaxed text-white/70 sm:text-xl">
            Explore how Micro and Macro keep your day organised and your wellbeing on track—with the calm glow and
            intelligent guidance you expect from Lumora Labs.
          </p>
        </div>
      </header>
          ...
          <div className="grid gap-10 lg:grid-cols-[1.1fr,0.9fr] lg:items-center">
            <div>
              ...
              <p className="mt-4 text-white/70 leading-relaxed">
                ...
                <span className="text-vibrant"> habit loops</span> into a single purposeful interface. It preserves the reliability of
                the services you already trust while layering <span className="text-vibrant">gentle nudges</span>,
                <span className="text-vibrant"> clarity</span>, and <span className="text-vibrant">rhythm</span> over your week. Plan,
                prioritise, and reflect without bouncing between apps.
              </p>

              <div className="mt-8 grid gap-4 sm:grid-cols-2">
                <div className="rounded-2xl border border-black/15 bg-[rgba(24,28,36,0.12)] p-5 text-white/80">
                  <h3 className="text-sm font-semibold text-vibrant">Seamless integrations</h3>
                  <p className="mt-2 text-sm">
                    Syncs with Apple Calendar and Reminders today, with <span className="text-vibrant">Google</span> and
                    <span className="text-vibrant"> Android</span> integrations on the horizon.
                  </p>
                </div>
                <div className="rounded-2xl border border-black/15 bg-[rgba(24,28,36,0.12)] p-5 text-white/80">
                  <h3 className="text-sm font-semibold text-vibrant">Habits that stick</h3>
                  <p className="mt-2 text-sm">
                    Layer intentional prompts over your schedule so daily routines become <span className="text-vibrant">effortless</span>,
                    not overwhelming.
                  </p>
                </div>
              </div>
        ...
        <section className="rounded-3xl border border-black/12 bg-[rgba(24,28,36,0.1)] p-8 md:p-12 backdrop-blur-xl shadow-[0_26px_64px_-35px_rgba(15,23,42,0.6)]">
          <div className="grid gap-10 lg:grid-cols-[1.1fr,0.9fr] lg:items-center">
            <div>
              ...
              <p className="mt-4 text-white/70 leading-relaxed">
                Macro pairs <span className="text-vibrant">intuitive logging</span> with an AI coach that speaks your language. It
                suggests <span className="text-vibrant">balanced meals</span>, adapts shopping lists to your preferences, and highlights
                progress in a way that keeps you motivated—not meticulous.
              </p>

              <div className="mt-8 grid gap-4 sm:grid-cols-2">
                <div className="rounded-2xl border border-black/15 bg-[rgba(24,28,36,0.12)] p-5 text-white/80">
                  <h3 className="text-sm font-semibold text-vibrant">Guided meal ideas</h3>
                  <p className="mt-2 text-sm">
                    Quick suggestions that respect your dietary goals, sensitivities, and the groceries you actually buy.
                  </p>
                </div>
                <div className="rounded-2xl border border-black/15 bg-[rgba(24,28,36,0.12)] p-5 text-white/80">
                  <h3 className="text-sm font-semibold text-vibrant">Effortless tracking</h3>
                  <p className="mt-2 text-sm">
