            ...
            <div className="grid gap-10 lg:grid-cols-[1.1fr,0.9fr] lg:items-center">
              <div>
                ...
                <p className="mt-4 text-base leading-relaxed text-gray-600 sm:text-lg">
                  Your <span className="text-vibrant">personal</span> nutritionist in your pocket. Chat with AI for advice on meals, symptoms, and <span className="text-vibrant">goals</span>. Log nutrition via <span className="text-vibrant">photo analysis</span>, barcode scanning, voice, or chat.
                </p>
            ...
            <div className="grid gap-10 lg:grid-cols-[1.1fr,0.9fr] lg:items-center">
              <div>
                ...
                <p className="mt-4 text-base leading-relaxed text-gray-600 sm:text-lg">
                  ...
                  <span className="text-vibrant"> habits</span> into a single purposeful interface. It layers gentle prompts and calm rhythm over your week so planning, prioritising, and reflecting feel effortless.
                </p>
